...
function ApplicationFormWrapper() {
  ...
  return (
    <ApplicationForm
      ...
      onSubmit={() => {
        toast.success(
          "Application submitted successfully! You will receive a confirmation notification.",
        );
        navigate("/jobs");
      }}
    />
...
function HMCandidateDetailWrapper() {
  ...
  return (
    <HMCandidateDetail
      candidateId={id || ""}
      onBack={() => navigate("/hiring/shortlisting")}
    />
  );
}
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route
          path="*"
          element={<UnderConstruction pageName="Admin Feature" />}
        />
      </Route>
      ...
      >
        ...
        <Route
          ...
          element={
            <JobRequisitionsPage
              onCreateRequisition={() =>
                navigate("/recruiter/requisitions/new")
              }
              onPublish={(id) => navigate(`/recruiter/post-job?req=${id}`)}
            />
          }
        />
        <Route
          ...
          element={
            <NewRequisitionPage
              onBack={() => navigate("/recruiter/requisitions")}
              onSuccess={() => navigate("/recruiter/requisitions")}
            />
          }
        />
        <Route
          ...
          element={
            <JobAdvertsPage
              onCreateAdvert={() => navigate("/recruiter/post-job")}
              onEditAdvert={(jobId) =>
        ...
        <Route
          path="*"
          element={<UnderConstruction pageName="Recruiter Feature" />}
        />
      </Route>
      ...
      >
        ...
        <Route
          ...
          element={
            <NewRequisitionPage
              onBack={() => navigate("/hiring/requisitions")}
              onSuccess={() => navigate("/hiring/requisitions")}
            />
          }
        />
        <Route
          ...
          element={
            <ShortlistingPage
              onViewCandidate={(id) =>
                navigate(`/hiring/candidate-detail/${id}`)
              }
            />
          }
        />
        <Route
          path="candidate-detail/:id"
          element={<HMCandidateDetailWrapper />}
        />
        <Route path="approvals" element={<OfferApprovalPage />} />
        <Route path="interviews" element={<InterviewsPage />} />
        <Route
          path="*"
          element={<UnderConstruction pageName="Hiring Manager Feature" />}
        />
      </Route>
