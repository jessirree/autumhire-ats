...
export function CreateJob({
  ...
  useEffect(() => {
    if (!editJobId) {
      setJobDetails((prev) => ({
        ...prev,
        requisitionId: "Auto-generated on save",
      }));
      return;
    }
    (async () => {
  ...
  const handleSave = async (isDraft: boolean = false) => {
    ...
    if (!isDraft) {
      if (hiringTeam.length === 0) {
        toast.error("Please add at least one member to the hiring team.");
        return;
      }
      if (!hiringCoordinatorId) {
        toast.error("Please select a hiring team coordinator.");
        return;
      }
    }
    ...
    const effectiveStatus: JobStatus = isDraft
      ? "Draft"
      : editJobId && jobDetails.status === "Draft"
        ? "Active"
        : editJobId
          ? (jobDetails.status as JobStatus)
          : "Active";
    ...
    try {
      if (editJobId) {
        ...
        if (fromRequisitionId && effectiveStatus === "Active") {
          await markRequisitionPublished(
            fromRequisitionId,
            created.id,
            user,
          ).catch(() => {});
  ...
  const availableStaff = staffMembers.filter(
    (member) => !hiringTeam.find((m) => m.id === member.id),
  );
      ...
      <div className="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between sticky top-0 z-10 transition-all duration-300">
        ...
        <div className="flex gap-3">
          ...
          {currentStep !== 5 ? (
            ...
            >
              {saving ? "Saving…" : editJobId ? "Save Changes" : "Publish Job"}{" "}
              ...
              {steps.map((step) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span
                      className={`text-xs font-semibold whitespace-nowrap transition-colors duration-300 ${isActive ? "text-[var(--pumpkin-orange)]" : "text-gray-500"}`}
                    >
                      {step.label}
                    </span>
                  </div>
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 transition-shadow hover:shadow-md">
              ...
              <p className="text-sm text-gray-500 mb-4">
                Create a new job by copying details from an existing job
                template.
              </p>
              <select
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="flex items-center gap-3 p-4 bg-blue-50/50 rounded-lg border border-blue-100 transition-colors hover:bg-blue-50">
                  ...
                  <label
                    ...
                    className="text-sm text-gray-700 cursor-pointer select-none w-full"
                  >
                    <span className="font-semibold block text-gray-900">
                      Confidential Job
                    </span>
                    <span className="text-gray-500">
                      Job will not appear on career site but will be published
                      on internal boards.
                    </span>
                  </label>
                </div>
                ...
                <div className="flex items-center gap-3 p-4 bg-green-50/50 rounded-lg border border-green-100 transition-colors hover:bg-green-50">
                  <input
                    ...
                    onChange={(e) =>
                      handleChange("showOnCareerSite", e.target.checked)
                    }
                  />
                  <label
                    htmlFor="careerSite"
                  ...
                  >
                    ...
                    <span className="text-gray-500">
                      Job will be visible to external candidates on your portal.
                    </span>
                  </label>
                </div>
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 transition-shadow hover:shadow-md">
              ...
              <p className="text-gray-500 mb-6">
                Configure the mandatory information required from all candidates
                when they apply.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-white rounded-lg border border-gray-200 flex items-center justify-between shadow-sm">
                  <div>
                    ...
                    <div className="text-sm text-gray-500">
                      Require candidates to upload a resume file
                    </div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
                      ...
                      onChange={(e) =>
                        handleSettingsChange("requireResume", e.target.checked)
                      }
                    />
                ...
                <div className="p-4 bg-white rounded-lg border border-gray-200 flex items-center justify-between shadow-sm">
                  <div>
                    ...
                    <div className="text-sm text-gray-500">
                      Require candidates to provide a cover letter
                    </div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input
        ...
        {currentStep === 3 && (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 transition-shadow hover:shadow-md">
              ...
              <p className="text-gray-500 mb-6">
                Create questions to prescreen candidates. You can ask for
                specific skills, experience, or other requirements.
              </p>
            ...
            {questions.length > 0 && (
              <div className="space-y-4">
                {questions.map((question, index) => (
                  <div
                    key={question.id}
                    className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 flex items-start gap-4 transition-all hover:shadow-md group"
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-3 text-sm text-gray-500 mb-2">
                        ...
                        {question.mandatory && (
                          <span className="bg-red-50 text-red-600 px-2 py-1 rounded text-xs uppercase font-medium">
                            Mandatory
                          </span>
                        )}
            ...
            {questionBank.length > 0 && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                ...
                <p className="text-sm text-gray-500 mb-4">
                  Questions maintained by admins in the Pre-screening Builder.
                </p>
                    ...
                    return (
                      <button
                        ...
                        title={
                          alreadyAdded
                            ? "Already added"
                            : `${bq.type}${bq.choices?.length ? ` • ${bq.choices.map((c) => `${c.label} = ${c.points} pts`).join(" · ")}` : bq.score ? ` • ${bq.score} pts` : ""}`
                        }
                      >
                        + {bq.text}
                      </button>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 transition-shadow hover:shadow-md border-l-4 border-l-[var(--pumpkin-orange)]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    onChange={(e) => {
                      ...
                      setCurrentQuestion((prev) => {
                        ...
                        if (newType === "checkbox") {
                          ...
                          next.choices = [
                            { label: "Yes", points: pts("Yes") },
                            { label: "No", points: pts("No") },
                          ];
                          next.expectedAnswer = undefined;
                          next.score = undefined;
                        } else if (newType === "dropdown") {
                          next.choices = prev.choices?.length
                            ? prev.choices
                  ...
                  currentQuestion.type !== "dropdown" && (
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Points added to the candidate's screening score when the
                        answer passes.
                      </p>
                    </div>
                  )}
                ...
                {currentQuestion.type === "dropdown" && (
                  <div className="col-span-2">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      The candidate's score is the points of the option they
                      pick.
                    </p>
                  </div>
                )}
              ...
              <div className="flex justify-end gap-3">
                <Button
                  ...
                  style={{
                    backgroundColor: !currentQuestion.text.trim()
                      ? "#ccc"
                      : "var(--pumpkin-orange)",
                  }}
                >
        ...
        {currentStep === 4 && (
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 transition-shadow hover:shadow-md">
              ...
              <p className="text-gray-500 mb-6">
                Select recruiters and team members who will have access to
                candidates and be part of the hiring process.
              </p>
              ...
              <div className="mb-8">
                ...
                <select
                  ...
                  value=""
                  onChange={(e) => {
                    const member = availableStaff.find(
              ...
              {hiringTeam.length > 0 && (
                <div className="space-y-3 mb-8">
                  <h3 className="text-sm font-semibold text-gray-900">
                    Selected Members ({hiringTeam.length})
                  </h3>
              ...
              <div className="bg-[var(--pumpkin-orange)]/5 rounded-lg border border-[var(--pumpkin-orange)]/10 p-6">
                ...
                <p className="text-xs text-gray-500 mb-4">
                  Select one person from the hiring team to be the primary point
                  of contact.
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleSettingsChange("hiringWorkflow", e.target.value)
                    }
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSettingsChange("closingDate", e.target.value)
                    }
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Job will automatically close for new applications on this
                    date.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      handleSettingsChange("recruitmentCost", e.target.value)
                    }
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Advertising/agency costs for this vacancy — feeds the
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  <h3 className="font-semibold text-gray-900 mb-4">
                    Job Board Visibility & Application Options
                  </h3>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      <div>
                        ...
                        <div className="text-xs text-gray-500">
                          Highlight this job on the career site
                        </div>
                      </div>
                      <input
                        type="checkbox"
              ...
              <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                <div>
                  ...
                  <dl className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <dd className="font-medium text-gray-900">
                      {jobDetails.currency} {jobDetails.salaryMin} -{" "}
                      {jobDetails.salaryMax}
                    </dd>

                    <dt className="text-gray-500">Confidential</dt>
                    <dd className="font-medium text-gray-900">
                      {jobDetails.isConfidential ? "Yes" : "No"}
                    </dd>
                  </dl>
                </div>
                ...
                <div>
                  ...
                  <dl className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <dd className="font-medium text-gray-900">
                      {hiringTeam.length} Members
                    </dd>

                    <dt className="text-gray-500">Coordinator</dt>
                    <dd className="font-medium text-gray-900">
                      {hiringTeam.find((m) => m.id === hiringCoordinatorId)
                        ?.name || "Not selected"}
                    </dd>

                    <dt className="text-gray-500">Closing Date</dt>
                    <dd className="font-medium text-gray-900">
                      {jobSettings.closingDate || "No date set"}
                    </dd>

                    <dt className="text-gray-500">Workflow</dt>
                    <dd className="font-medium text-gray-900">
                      {jobSettings.hiringWorkflow}
                    </dd>
                  </dl>
                  ...
                  {questions.length > 0 && (
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      <div className="text-xs font-bold text-[var(--pumpkin-orange)] uppercase mb-2">
                      ...
                      <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-1">
                        {questions.map((q) => (
                          ...
                          >
                            ...
                            <span className="text-gray-400 text-[11px] ml-auto uppercase">
                              {q.type}
                            </span>
                          </li>
                        ))}
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        See how this job looks to candidates on the career
                        portal.
                      </p>
                    </div>
                  </div>
            ...
            <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  How this job looks to candidates on the career portal
                </p>
              </div>
              <button
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-8 mb-6">
                ...
                <div className="flex flex-wrap items-center gap-6 text-gray-600 mb-6">
                  ...
                  <span className="flex items-center gap-2">
                    ...
                    {jobDetails.location || "—"}{" "}
                    {jobDetails.remoteType ? `(${jobDetails.remoteType})` : ""}
                  </span>
                  <span className="flex items-center gap-2">
                  ...
                  <>
                    ...
                    <section>
                      ...
                      <p className="text-gray-600 text-sm">
                        This application includes {questions.length}{" "}
                        pre-screening question{questions.length > 1 ? "s" : ""}.
                      </p>
                    </section>
                  </>
                )}
